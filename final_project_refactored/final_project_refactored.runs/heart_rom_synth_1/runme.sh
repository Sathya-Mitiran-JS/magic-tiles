...
HD_PWD='C:/Users/dshen/FA25/ECE385/final_project/final_project.runs/heart_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heart_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heart_rom.tcl
